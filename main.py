...
services_info = {
    ...
    "mockup": "پیاده‌سازی طرح‌ها روی موکاپ واقعی.\n\n"
              "⏱ زمان انجام: 1 تا 2 روز کاری\n"
              "✏️ تعداد ویرایش رایگان: 1 بار\n"
              "💰 هزینه تقریبی: 150 هزار تومان\n\n"
              "مدت زمان و هزینه پروژه بسته به پیچیدگی طرح شما ممکن است متفاوت باشد."
}
...
def handle_services(call):
    ...
    # بازگشت به صفحه خدمات
        ...
        bot.edit_message_text(chat_id=chat_id, message_id=call.message.message_id,
                              text="🩷 لطفا خدمات مورد نظر خود را انتخاب کنید:", reply_markup=services_inline())
