...
def start_msg(message):
    bot.send_message(message.chat.id,
                     "به دنیای خدمات گرافیکی آکاردو خوش اومدی💭🪷                              🪽طراحی سفارشی و متناسب با نیازهای شما 
🪽 طرح‌های سفارشی متناسب با نیازهای خودتون داشته باشید
🪽 از رنگ‌ها و اشکال منحصر به فرد استفاده کنید
🪽 سفارشات رو به موقع و با کیفیت دریافت کنید
🪽 مشاوره رایگان برای انتخاب بهترین طرح بگیرید

✨ همین حالا پیام بدید و اولین قدم رو برای موفقیت کسب و کارتون بردارید!
